package br.com.matheussilva.controller;
...
import br.com.matheussilva.persistencia.jdbc.UsuarioDAO;

//http://localhost:8080/javaweb/usucon.do
@WebServlet("/usucon.do")
public class UsuarioController extends HttpServlet 
{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException 
    {
        ...
        if (acao.equals("exc")) {
            ...
            resp.sendRedirect("usucon.do?acao=lis");
